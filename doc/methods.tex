...
Expanding on the basic model involves modeling the observation, origination and survival as independent multi-level logistic regressions. The model of observation probability follows a different % HERE
