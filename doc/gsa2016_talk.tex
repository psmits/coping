...
\begin{frame}
  ...
  % model with parameters inferred via ADVI fit isn't very adequate
  %   but no one else checks their model adequacy (e.g. liow)
  % interpretability
  %   explaining this to a non-statistician/ecologist is a nightmare
\end{frame}
